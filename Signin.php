...
<head>
    ...
    <link rel="stylesheet" href="resources/bootstyle.css">
    <link rel="stylesheet" href="https://fonts.google.com/share?selection.family=Montserrat:ital,wght@0,100..900;1,100..900|Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900">
</head>
<body>
    <!---header logo    ---->
    <div class="logo">
    ...
    <form action="includes/signup.inc.php" method="post">
       ...
       <div class="input-group mb-3">
        ...
        <div class="row " >
            <small class="text-center">Don't have an account? <a href="index.php">Register Now</a></small>
        </div>
    </div>
